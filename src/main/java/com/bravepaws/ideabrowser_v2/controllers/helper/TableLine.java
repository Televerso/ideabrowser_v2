...
public class TableLine implements Serializable {
    ...
    public TableUsers getL_user() {
        return l_user;
    }

    public TableThemes getL_theme() {
        return l_theme;
    }

    public TableIdeas getL_idea() {
        return l_idea;
    }

    public void setL_user(TableUsers l_user) {
        this.l_user = l_user;
    }

    public void setL_theme(TableThemes l_theme) {
        this.l_theme = l_theme;
    }

    public void setIdea(TableIdeas idea) {
        this.l_idea = idea;
    }
}
